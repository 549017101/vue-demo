<template>
  <div>
    <nav-bar class="nav-bar"><template #center>我的商城</template></nav-bar>
    <user-info></user-info>
...
<script>
  ...
  import UserInfo from "@/views/profile/childrenComponents/UserInfo";
  import ListView from "@/views/profile/childrenComponents/ListView";
  export default {
    components: {
      NavBar,
      UserInfo,
